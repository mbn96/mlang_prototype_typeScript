...
export class Lexter {
    ...
    public tokenize(): Token[] {
        ...
        while (this.currentChar) {
            ...
            if (char === '+') {
                ...
                this.appendToken({ type: TokenType.L_C_BRACKET });
                this.advance();
            } else if (char === '}') {
                this.appendToken({ type: TokenType.R_C_BRACKET });
                this.advance();
            }
            else if (char === ',') {
    ...
    private get_ID_KW() {
        ...
        if (token_str in Keywords) {
            this.appendToken({ type: TokenType.TT_KEYWORD, keyword: Keywords[token_str] })
        } else {
